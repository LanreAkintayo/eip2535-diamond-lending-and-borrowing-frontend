        ...
        <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          >
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              ...
              <li className="items-center">
                {/* <Link href="/">
                  <a className="text-blueGray-700 hover:text-blueGray-500 text-xs
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
              <li className="inline-flex">
                {/* <Link href="/">
                  <a className="text-blueGray-700 hover:text-blueGray-500 text-sm block mb-4 no-underline font-semibold"><i className="fas fa-paint-brush mr-2 text-blueGray-400 text-base"></i>{" "} Styles</a>
                </Link> */}
              </li>

              <li className="inline-flex">
                {/* <Link href="/">
                  <a className="text-blueGray-700 hover:text-blueGray-500 text-sm block mb-4 no-underline font-semibold">
